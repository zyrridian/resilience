...
public class KeyHandler implements KeyListener {
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (code == KeyEvent.VK_J || code == KeyEvent.VK_ENTER)
            enterPressed = false;
        if (code == KeyEvent.VK_K || code == KeyEvent.VK_SPACE)
            spacePressed = false;
        if (code == KeyEvent.VK_L || code == KeyEvent.VK_CONTROL)
    ...
    public void handleTitleState(int code) {
        ...
        } else if (gamePanel.ui.titleScreenState == 5) {
            if (code == KeyEvent.VK_ENTER) {
                gamePanel.playSoundEffect(GamePanel.SFX_UNLOCK);
                // gamePanel.gameState = GamePanel.PLAY_STATE;
                // gamePanel.playMusic(22);
    ...
    public void handlePlayState(int code) {
        ...
        if (code == KeyEvent.VK_C || code == KeyEvent.VK_I)
        ...
        if (code == KeyEvent.VK_R) {
            switch (gamePanel.currentMap) {
                case 0:
                    gamePanel.tileManager.loadMap("/maps/kota01.txt", 0);
                    break;
                case 1:
                    gamePanel.tileManager.loadMap("/maps/kota02.txt", 1);
                    break;
                case 2:
                    gamePanel.tileManager.loadMap("/maps/kota03.txt", 2);
                    break;
                case 3:
                    gamePanel.tileManager.loadMap("/maps/kota04.txt", 3);
                    break;
                case 4:
                    gamePanel.tileManager.loadMap("/maps/kota05.txt", 4);
                    break;
            }
    ...
    public void handleCharacterState(int code) {
        if (code == KeyEvent.VK_C || code == KeyEvent.VK_I || code == KeyEvent.VK_ESCAPE)
            gamePanel.gameState = GamePanel.PLAY_STATE;
        if (code == KeyEvent.VK_ENTER)
    ...
    public void handleOptionsState(int code) {
        ...
        if (code == KeyEvent.VK_W || code == KeyEvent.VK_UP) {
            ...
            gamePanel.playSoundEffect(GamePanel.SFX_CURSOR);
            if (gamePanel.ui.commandNumber < 0)
                gamePanel.ui.commandNumber = maxcCommandNum;
        }
        if (code == KeyEvent.VK_S || code == KeyEvent.VK_DOWN) {
            gamePanel.ui.commandNumber++;
            gamePanel.playSoundEffect(GamePanel.SFX_CURSOR);
            if (gamePanel.ui.commandNumber > maxcCommandNum)
                gamePanel.ui.commandNumber = 0;
        }
        if (code == KeyEvent.VK_A || code == KeyEvent.VK_LEFT) {
