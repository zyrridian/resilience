...
public class NPC_Professor extends Entity {
    ...
    public void getImage() {
        ...
        up1 = setup("/npc/sastro_walk_up_1", gamePanel.tileSize, gamePanel.tileSize);
        up2 = setup("/npc/sastro_walk_up_2", gamePanel.tileSize, gamePanel.tileSize);
        left1 = setup("/npc/sastro_walk_left_1", gamePanel.tileSize, gamePanel.tileSize);
        left2 = setup("/npc/sastro_walk_left_2", gamePanel.tileSize, gamePanel.tileSize);
        down1 = setup("/npc/sastro_walk_down_1", gamePanel.tileSize, gamePanel.tileSize);
        down2 = setup("/npc/sastro_walk_down_2", gamePanel.tileSize, gamePanel.tileSize);
        right1 = setup("/npc/sastro_walk_right_1", gamePanel.tileSize, gamePanel.tileSize);
        right2 = setup("/npc/sastro_walk_right_2", gamePanel.tileSize, gamePanel.tileSize);
    }
