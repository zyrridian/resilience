...
public class NPC_Sastro extends Entity {

    public static final String npcName = "Sastro";

    public NPC_Sastro(GamePanel gamePanel) {
        super(gamePanel);
    ...
    public void getImage() {
        avatar = setup("/npc/sastro_base_avatar", gamePanel.tileSize, gamePanel.tileSize);
        up1 = setup("/npc/sastro_base_walk_up_1", gamePanel.tileSize, gamePanel.tileSize);
        up2 = setup("/npc/sastro_base_walk_up_2", gamePanel.tileSize, gamePanel.tileSize);
        left1 = setup("/npc/sastro_base_walk_left_1", gamePanel.tileSize, gamePanel.tileSize);
        left2 = setup("/npc/sastro_base_walk_left_2", gamePanel.tileSize, gamePanel.tileSize);
        down1 = setup("/npc/sastro_base_walk_down_1", gamePanel.tileSize, gamePanel.tileSize);
        down2 = setup("/npc/sastro_base_walk_down_2", gamePanel.tileSize, gamePanel.tileSize);
        right1 = setup("/npc/sastro_base_walk_right_1", gamePanel.tileSize, gamePanel.tileSize);
        right2 = setup("/npc/sastro_base_walk_right_2", gamePanel.tileSize, gamePanel.tileSize);
    }
